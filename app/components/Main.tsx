...
export default function Main() { 
    return (
        <div className="mt-25 flex flex-col justify-center gap-y-8 mlg:gap-y-0 mlg:flex-row mlg:gap-x-15 items-center p-6">
            <div className="flex mlg:ml-4 h-full gap-y-12 mlg:gap-y-0 flex-col-reverse md:flex-row mlg:w-2/5 gap-x-2 items-center">
                ...
                <div className="relative w-[80vw] h-[80vw] mlg:w-[400px] mlg:h-[400px] aspect-square">
                    <Image 
                        src={'/background.jpg'} 
                        alt="album pic" 
                        layout="fill"
            ...
            <div className="self-start mlg:self-center  mlg:p-8 w-full mlg:w-1/2 h-full flex flex-col gap-y-8 mlg:gap-y-16 mlg:justify-center items-start">
